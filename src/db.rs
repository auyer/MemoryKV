...
impl KVStore {
    ...
    pub fn list_keys_with_prefix(&self, prefix: &str) -> Vec<String> {
        self.wal_tx.send(KVWAL::ListPrefix{prefix: prefix.to_string()});
        self.db
            .read()
            .keys()
